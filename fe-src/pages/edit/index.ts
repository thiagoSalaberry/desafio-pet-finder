...
class EditReportPage extends HTMLElement {
    ...
    async render() {
        ...
        <section class="report-pet">
            <custom-text tag="h1" variant="title">Editar reporte de ${currentState.reportToEdit.pet_name}</custom-text>
            <form id="report-pet-form">
                <div class="input-container">
                    <label for="name"><custom-text tag="p" variant="label">NOMBRE</custom-text></label>
                    <input type="text" id="name" class="input" placeholder="${currentState.reportToEdit.pet_name}"/>
                </div>
                <div class="picture-container">
                    <div class="pre-picture" id="drop-here">
                        <img class="current-img" src="${currentState.reportToEdit.img}"/> 
                    </div>
                ...
                <custom-button class="add-pic-button" color="blue">Modificar foto</custom-button>
                ...
                <div class="input-container">
                    ...
                    <textarea name="last-seen" class="textarea" id="message" placeholder="${currentState.reportToEdit.message}"></textarea>
                </div>
                <custom-button class="submit-button" color="blue">Editar reporte</custom-button>
                <custom-button class="delete-button" color="red">Eliminar reporte</custom-button>
            </form>
        </section>
        `;
        ...
        setupMap([currentState.reportToEdit.last_seen_lon, currentState.reportToEdit.last_seen_lat], 15);
        ...
        const ubicationInputEl:HTMLInputElement = this.querySelector(".mapboxgl-ctrl-geocoder--input");
        ubicationInputEl.placeholder = currentState.reportToEdit.last_seen
